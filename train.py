...
# Updated imports for timm 0.6.13
from timm.data import resolve_data_config, Mixup, FastCollateMixup, AugMixDataset  # Dataset removed as it's not available in timm 0.6.13
from timm.data.dataset import ImageDataset as Dataset  # Updated import for Dataset
from timm.models import create_model, resume_checkpoint, convert_splitbn_model
from timm.utils import *
from timm.loss import LabelSmoothingCrossEntropy, SoftTargetCrossEntropy, JsdCrossEntropy
from timm.optim import create_optimizer_v2 as create_optimizer  # Updated for timm 0.6.13
...
parser.add_argument('--repeated-aug', default=True)
...
parser.add_argument('--mixup', type=float, default=.8,
...
def main():
    ...
    # Updated for timm 0.6.13 - create_optimizer_v2 expects different argument order
    optimizer = create_optimizer(opt='adamw', model_or_params=model)
